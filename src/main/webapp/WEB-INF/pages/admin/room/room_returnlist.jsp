...
{
	$("#queryForm").attr("action","${pageContext.request.contextPath }/room/returnlist?page="+(new_page_index + 1));
	$("#queryForm").submit();
}
...
<body>
  ...
  <div class="panel-head">
	...
	<a class="btn btn-success" href="${pageContext.request.contextPath}/room/returnlist?page=1&street_name=${street_name }&isRent=1" style="margin-left:30px;">转租房</a>
	...
	<div>
		<form id="queryForm" action="${pageContext.request.contextPath }/room/returnlist?page=1" method="post">
